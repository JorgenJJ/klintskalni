...
about:
  title: Par Klintskalni 1
  emailNote: 'Vari arī rezervēt tieši pa e-pastu:'
houses:
...
nearby:
  ...
  intro: ''
  linkLabel: Atvērt Google Maps
  categoryLabels:
    shop: Veikali
    restaurant: Ēdiens un dzērieni
    activity: Aktivitātes un apskates vietas
  items:
    - id: butikk-verdins
      description: Pārtikas preces, atvērts visu nedēļu.
    - id: liedags
      description: Kafejnīca un vienkāršas vakariņas.
    - id: veczemju-klintis
      description: Sarkanā smilšakmens klintis un nelielas alas gar krastu.
    - id: butikk-elvi
      description: Pārtikas preces, atvērts visu nedēļu.
    - id: mat-sidrabini
    - id: mat-meke
